...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-semibold tracking-wide ring-offset-background transition-colors focus-visiblne focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        ringHover:
          "bg-primary text-primary-foreground transition-all hover:bg-primary-foreground hover:text-primary hover:ring hover:ring-ring hover:ring-offset",
        shine:
